...
def is_safe_url(url: str) -> bool:
    ...
    Prevents SSRF by checking all resolved IP addresses (v4 and v6) for private,
    ...
    try:
        ...
        # We must check all IPs because a single hostname can point to multiple addresses.
        try:
