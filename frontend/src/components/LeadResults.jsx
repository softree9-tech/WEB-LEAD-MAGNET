...
import { RefreshCw, Download, Monitor, Mail, Lock, FileCode, Check, X, Search, Activity, BarChart3, Settings, ChevronUp, LayoutDashboard, FileText, Bot, Target, Smartphone, Copy, TrendingDown, AlertTriangle, Sword, Trophy, Zap, Sparkles } from 'lucide-react';
...
function calculateMobileResponsivenessScore(lead) {
  ...
  const _problematicRatio = _problematicSections / totalSections;
            ...
            <div className="elite-main" id={`lead-${index}`}>
              <div className="elite-header">
                ...
                <div className="header-actions">
                  ...
                  >
                    <Download size={14} /> {isPublic ? 'Download Audit Report' : 'Export to Excel'}
                  </button>
