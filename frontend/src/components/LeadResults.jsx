...
function CopyButton({ content }) {
  ...
  return (
    <button className="action-btn" onClick={handleCopy} aria-live="polite">
      {copied ? (
        <span style={{ color: 'var(--success-color)', display: 'flex', alignItems: 'center', gap: '0.5rem' }}>
