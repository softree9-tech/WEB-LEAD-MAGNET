              ...
              <div className="quad-card" id={`lead-${index}-outreach`} style={{ marginTop: '1.5rem', flex: 'none' }}>
                <div className="quad-header" style={{ marginBottom: '1rem' }}>
                  ...
                  <button
                    ...
                    onClick={() => handleCopy(emailBody, index)}
                    aria-label={copiedIndex === index ? "Email copied to clipboard" : "Copy outreach email to clipboard"}
                  >
                    {copiedIndex === index ? (
                      <span role="status" aria-live="polite" style={{ color: '#10b981', display: 'flex', alignItems: 'center', gap: '0.5rem' }}>
