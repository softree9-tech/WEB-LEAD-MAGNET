...
function calculateMobileResponsivenessScore(lead) {
  ...
  const _problematicRatio = problematicSections / _totalSections;
              ...
              {!isPublic && (
                <div className="quad-card" id={`lead-${index}-outreach`} style={{ marginTop: '1.5rem', flex: 'none' }}>
                  <div className="quad-header" style={{ marginBottom: '1rem' }}>
                    ...
                    <button className="action-btn" onClick={() => handleCopy(emailBody, index)}>
                      {copiedIndex === index ? (
                        <span style={{ color: '#10b981', display: 'flex', alignItems: 'center', gap: '0.5rem' }} aria-live="polite">
