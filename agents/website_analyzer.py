...
def check_single_link(link: str) -> str:
    ...
    try:
        ...
        if res.status_code in [403, 405, 401, 301, 302, 999]:
            res = requests.get(
                link, timeout=10, allow_redirects=True, headers=headers, stream=True
            )
            res.raw.close()
    ...
    if url:
        ...
        try:
            with sync_playwright() as p:
                ...
                # Reuse BeautifulSoup object to avoid redundant parsing
            ...
            try:
                ...
                # Reuse BeautifulSoup object in fallback as well
                soup = BeautifulSoup(html, "html.parser")
...
- Trust Signals (Strong, Weak, Missing - scan the text specifically for Client Reviews, Testimonials, Case Studies, partner mentions, or awards!)"""
        ...
        system_msg = SystemMessage(
            content=f"""You are an elite Digital Marketing agency owner auditing a prospect's website to sell them a WEBSITE REDEVELOPMENT + SEO OPTIMIZATION project.
